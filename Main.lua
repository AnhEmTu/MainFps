...
ImageButton.Image = "http://www.roblox.com/asset/?id=85966608442070"
...
local SelectFastAttackMode = (SelectFastAttackMode or "Tấn công nhanh")

SelectedFastAttackMode = {"Tấn công bình thường','Tấn công nhanh','Tấn công siêu nhanh','Tấn công siêu siêu nhanh"}

local function ChangeModeFastAttack(SelectFastAttackMode)
	if SelectFastAttackMode == "Tấn công bình thường" then
		FireCooldown = 0.2
	elseif SelectFastAttackMode == "Tấn công nhanh" then
		FireCooldown = 0.10
	elseif SelectFastAttackMode == "Tấn công siêu nhanh" then
		FireCooldown = 0.05
	elseif SelectFastAttackMode == "Tấn công siêu siêu nhanh" then
		FireCooldown = 0.01
	  end
  end
end
					...
					if game.Players.LocalPlayer.Backpack:FindFirstChild("God's Chalice") or game.Players.LocalPlayer.Character:FindFirstChild("God's Chalice") then
						if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SweetChaliceNpc"),"Where") then
							game.StarterGui:SetCore("SendNotification", {
								...
								Icon = "http://www.roblox.com/asset/?id=85966608442070",
								Duration = 2.5
							})
						else
